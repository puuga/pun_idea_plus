<?php
  ...
  // $code     = 'P123456789012'; // barcode, of course ;)
  $code     = isset($_GET["code"])?$_GET["code"]:'P123456789012'; // barcode, of course ;)
  $type     = 'code39'; //'ean13';
  ...
  //                    MIDDLE AXE
  // -------------------------------------------------- //
  // imageline($im, $x, 0, $x, 300, $red);
  // imageline($im, 0, $y, 300, $y, $red);
